...
# Function to perform XGBoost classification for particular years
...
def main():
    ...
    model_2002_2005 = xgboost_classification(2002, 2005, features, target, save_directory)
    ...
    model_2002_2015 = xgboost_classification(2002, 2015, features, target, save_directory)
